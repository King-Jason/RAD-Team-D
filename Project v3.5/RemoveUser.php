<!--
 Version 1 : Made membership page and administrative functions : Christina Tatang
 Version 2.1: Made website responsive : Jason King
 Version 2.2: Minor php code convention fixes using PHP_CodeSniffer and PHP Beautifier refer
